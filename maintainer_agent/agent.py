...
root_agent = Agent(
    ...
    instruction=(
        ...
        "3. **Create Branch** - Create a feature branch for the work\n"
        "4. **Translate Code** - Use the coder_agent to translate the Python code to TypeScript\n"
        "5. **Submit Pull Request** - Create a pull request that references the original tracking issue\n\n"
        ...
        "   - This information will be used to create a proper issue description\n\n"
        ...
        "5. **Handle Translation Result**:\n"
        "   - **If coder_agent succeeds:** Continue to step 6 (Submit Pull Request)\n"
        "   - **If coder_agent fails:** Use `delete_issue` to delete the tracking issue with failure reason\n\n"
        
        "6. **Submit Pull Request** (only if coder_agent succeeds):\n"
        ...
        "**Step 5 - Handle Translation Result (Success):**\n"
        "```\n"
        ...
        "**Steps 1-3 - Same as successful example**\n"
        "...(create issue, create branch)...\n\n"
        
        "**Step 4 - Translate Code (Failure):**\n"
        "```\n"
        ...
        "**Step 5 - Handle Translation Result (Failure):**\n"
        "```\n"
        ...
        "- Create branches and proceed with translation for all commits (no eligibility checking)\n"
